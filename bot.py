...
async def post_init(application: Application) -> None:
    ...
    await application.bot.set_my_commands([
        ...
        BotCommand("dashboard", "Open the rich dashboard"),
        BotCommand("commute", "Smart train plan for next class"),
